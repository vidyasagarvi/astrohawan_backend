...
class ServicesProductService {
    addServicesProduct(productData) {
        ...
        return new Promise((resolve, reject) => {
            connection.beginTransaction(err => {
                ...
                connection.query('INSERT INTO services_products (id, images, price) VALUES (?, ?, ?)', [id, JSON.stringify(images),price] , (err, result) => {
                    if (err) {
                    ...
                    const translationPromises = translations.map(translation => {
                        return new Promise((resolve, reject) => {
                            connection.query(
                                `INSERT INTO services_products_translations (id, services_id, language_code, title, description)
                                 VALUES (UUID(), ?, ?, ?, ?)`,
